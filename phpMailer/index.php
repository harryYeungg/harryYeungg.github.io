...
<!-- Content-->
	...
	<div class = "container header" ">
		<div class = row>
			<div class = "hidden-xs col-sm-4 col-md-4 col-lg-4" >
				...
				<a href="index.php"><img src="logo 4 bball.png" width="220" height="130"  ></a>
			</div>
			<div class = "hidden-xs col-sm-offset-3 col-sm-5 col-md-offset-3 col-md-5 col-lg-offset-3 col-lg-5" style="text-align: right; margin-top: 23px;">
				<ul>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a href="index.php"><img src="logo 4 bball.png" width="130" height="80"  style="margin-left: 10px;"></a>
    </div>
	...
	<div class = container style="margin-top: 60px;  ">
		<div class = row style="text-align: center;">
			<div class = "col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<h4>Sign up for the first time to get the verification code and use it to search courts anytime you want</h4>
			</div>
		</div>
	...
	<!-- Creating the buttons-->
  	...
  	<div class = row style="margin-top: 30px;">
		...
		<button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#signUpModal" style="display: block; margin-right: auto; margin-left: auto; padding-left: 75px; padding-right: 75px;">Sign Up</button>
			      ...
			      <form action="index.php" method="post" id=signUpForm>
				    ...
				    <?php 
				    	...
				    	if ($_POST["email"]) {
							...
							mail ("courtsearchh@gmail.com" , "Requesting verification code" ,"Please send a verification code to " . $email , "From: " . $email . "\r\n" . "Reply-to: " . $email);
	...
	<div class = row style="margin-top: 10px;">
		...
		<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="display: block; margin-right: auto; margin-left: auto; padding-left: 81px; padding-right: 81px; background-color: #3498DB; border-style: none; " id=logInButton1 >Log In</button>
	...
	<footer class = "hidden-xs" style="margin-top: 220px;" >
		
			<div class = row style="text-align: center;">
				<h6>&#9400 2017 CourtSearch.Co</h6>
			</div>
